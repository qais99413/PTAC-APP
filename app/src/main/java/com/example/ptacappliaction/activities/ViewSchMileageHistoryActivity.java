...
public class ViewSchMileageHistoryActivity extends BaseActivity {

    DatabaseReference databaseReference;
    RecyclerView recyclerView;
    TextView textView;
    List<SchMileageModel> list;
    public static SchMileageModel model;

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sch_mileage_history);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1 : snapshot.getChildren()){
                    SchMileageModel model = snapshot1.getValue(SchMileageModel.class);
                    list.add(model);
                }
                if(list.size()>0){
                    EventsListAdapter adapter = new EventsListAdapter(ViewSchMileageHistoryActivity.this,list);
    ...
    public class EventsListAdapter extends RecyclerView.Adapter<EventsListAdapter.ImageViewHolder>{
        ...
        private List<SchMileageModel> muploadList;

        public EventsListAdapter(Context context , List<SchMileageModel> uploadList ) {
            mcontext = context ;
        ...
        public void onBindViewHolder(final ImageViewHolder holder, @SuppressLint("RecyclerView") final int position) {
            ...
            final SchMileageModel model = muploadList.get(position);
            holder.tvName.setText("Date: "+model.getDate());
            holder.tvPrice.setText("KM of Car: "+model.getKm()+"km");
            holder.tvDuration.setText("Next Service: "+model.getNextService());
            holder.tvTime.setText("Oil Type: "+model.getOilType());
